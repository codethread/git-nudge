import{r as g,j as r,P as b,c as y,u as N,a as C,b as O,E as m,L as E,d as S,e as w}from"./index-DaweCC-q.js";import{g as I,C as M,a as P,b as T,c as z}from"./card-5Qe5Of3g.js";var A="Separator",j="horizontal",F=["horizontal","vertical"],v=g.forwardRef((t,s)=>{const{decorative:i,orientation:a=j,...u}=t,n=U(a)?a:j,f=i?{role:"none"}:{"aria-orientation":n==="vertical"?n:void 0,role:"separator"};return r.jsx(b.div,{"data-orientation":n,...f,...u,ref:s})});v.displayName=A;function U(t){return F.includes(t)}var k=v;function L({className:t,orientation:s="horizontal",decorative:i=!0,...a}){return r.jsx(k,{"data-slot":"separator-root",decorative:i,orientation:s,className:y("bg-border shrink-0 data-[orientation=horizontal]:h-px data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-px",t),...a})}const _=I(`
	query GetMyMrs {
		currentUser {
			id
			name
